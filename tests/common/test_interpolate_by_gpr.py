...
class TestInterpolateByGpr(unittest.TestCase):
    def test_interpolate_by_gpr(self):
        """
        ...
        grid_array = interpolate_by_gpr(ob_point_ndarray, ob_point_file_path)
        ...
        self.assertEqual((target_point_lat_idx, target_point_lon_idx), grid_data_max_idxs)
